...
def writeTableToFile(filename,songname,trackname,bpm, table,first_state):
	...
	head=(songname,trackname,bpm,first_state,numRows,numCols)
	...
	out_file.write("#(Song title, Track Name, Bpm, (First state), rows, cols)\n")
	
	#write header
	out_file.write("('%s', '%s', %s, %s, %s, %s)\n\n" % head)
	
	out_file.write("#Transition probability table\n")
